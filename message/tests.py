...
class TestMessage(APITestCase):
    ...
    def setUp(self):
        ...
        UserProfile.objects.create(
            first_name="sender", last_name="sender", user=self.sender, caption="sender")
        ...
        self.receiver = CustomUser.objects._create_user(
            "receiver@mail.ru", "receiver123")
        UserProfile.objects.create(
            first_name="receiver", last_name="receiver", user=self.receiver, caption="receiver")
    ...
    def test_post_message(self):
        ...
        self.assertEqual(result["sender"]["user"]["email"], "sender@mail.ru")
        self.assertEqual(result["receiver"]["user"]["email"], "receiver@mail.ru")
